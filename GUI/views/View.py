...
from PySide6.QtWidgets import QWidget, QVBoxLayout, QLineEdit, QMessageBox, QTableWidget, QTableWidgetItem, QPushButton
...
class View(QWidget):
    ...
    def load_ui(self, design_file: str):
        loader = QUiLoader()
        path = os.fspath(Path(__file__).resolve().parent / design_file)
        ui_file = QFile(path)
