...
These files are just dummy templates in the `master` branch. The actual template of `VZOR - Záväzné vyjadrenie DPO.docx` is **not** included. 
...
- `DPO-log_{success}_{time_stamp}.txt` - informs user about success / failure of the script
